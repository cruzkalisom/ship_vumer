...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `name` varchar(100) NOT NULL DEFAULT 'Kalisom',
  `surname` varchar(255) NOT NULL DEFAULT 'Cruz',
  `identifier` varchar(7) NOT NULL DEFAULT '0',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- Copiando dados para a tabela ship_vumer.users: ~0 rows (aproximadamente)
